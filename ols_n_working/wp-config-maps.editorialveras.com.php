...
define( 'WPCACHEHOME', '/home2/radiofq1/public_html/maps/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('WP_CACHE', true); //Added by WP-Cache Manager


define('DB_NAME', 'radiofq1_verasmap');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'radiofq1_usermap');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'V3r45M4p5');
